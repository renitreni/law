<div>
    ...
    <div class="row mt-4">
        ...
        <div class="mb-3 col-md-4">
            <label for="court_name" class="form-label">Court Name/اسم المحكمة</label>
        ...
        <div class="mb-3 col-md-4">
            <label for="court_address" class="form-label">Address/العنوان</label>
        ...
        <div class="mb-3 col-md-4">
            <label for="court_date" class="form-label">Date/تاريخ</label>
