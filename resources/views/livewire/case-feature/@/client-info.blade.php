<div>
    ...
    <div class="row mt-4">
        <div class="mb-3 col-md-4">
            <label for="client_name" class="form-label">Full Name/الاسم الكامل</label>
        ...
        <div class="mb-3 col-md-4">
            <label for="client_contact" class="form-label">Contact/الاتصال</label>
        ...
        <div class="mb-3 col-md-2">
            <label for="client_age" class="form-label">Age/العمر</label>
        ...
        <div class="mb-3 col-md-2">
            <label for="client_birthday" class="form-label">Birthdate/تاريخ الميلاد</label>
        ...
        <div class="mb-3 col-md-4">
            <label for="client_role" class="form-label">Role/الدور</label>
        ...
        <div class="mb-3 col-md-4">
            <label for="client_attorney" class="form-label">Attorney/محامي</label>
