<div>
    ...
    <div class="mb-3" x-cloak x-data="{open:false}">
        <form enctype="multipart/form-data" wire:submit='save' class="d-flex flex-row-reverse gap-2">
            ...
            <div class="d-flex flex-column">
                <input required="required" accept="image/*" wire:model.live='photos' x-transition x-show="open" multiple
