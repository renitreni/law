        ...
        <div class="row d-flex">
            <div class="col-md-6 d-flex">
                <div class="img img-video d-flex align-self-stretch align-items-center justify-content-center justify-content-md-end"
                    style="background-image:url({{ asset('theme/images/about.jpg') }});border-radius:8px;">
            ...
            <div class="col-md-6 pl-md-5">
                <div class="row justify-content-start pt-3 pb-3">
                    <div class="col-md-12 heading-section ftco-animate">
                        ...
                        <h2 class="mb-4">We ensure justice prevails</h2>
                        <p style="font-size: 14px;">Far far away, behind the word mountains, far from the countries
