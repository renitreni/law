    ...
    <div class="p-5">
        <div class="row">
            ...
            <p style="font-weight: 300;" class="col-md-6">
                For nearly two decades, <strong>Meshari Al Humaidi Law Firm</strong> has consistently occupied a prominent position in the legal services domain. The firm has achieved remarkable successes and earned recognition from various corporations, government institutions, and esteemed embassies.
            </p>
        </div>
        ...
        <div style="margin-top: 3rem;" class="row">
            <div  class="col-md-6 d-flex justify-content-center align-items-center">
                <img src="https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" class="img-fluid rounded shadow" style="width:100%;height:300px;">
            </div>
        ...
        <div style="margin-top: 3rem;" class="row">
            ...
            <div style="font-weight: 300;" class="col-md-6">
                ...
                <p>
                    At Meshari Al Humaidi Law Firm, we provide a variety of customized legal services designed to address the specific needs of our clients. Our unwavering commitment revolves around protecting your rights and ensuring security in various situations and cases
                </p>

                <p>
                    We offer extensive legal and judicial representation for commercial, industrial establishments, and individuals.
                </p>
                <p>
                    Our expert legal guidance helps clients navigate intricate legal situations and resolve contentious matters.
                </p>
            </div>
        </div>
    </div>
    <div style="background-color: rgb(241 245 249);margin-top:3rem;" class="p-5">
        <div class="row">
            <div class=" col-md-4">
                <div class="image-box shadow">
                    <img class="img-fluid rounded" src="https://images.unsplash.com/photo-1571624436279-b272aff752b5?q=80&w=1472&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Riyadh">
                </div>
                <div class=" mt-4">
                    <span class="text-xl">Riyadh Head Office</span>
                </div>
            </div>
            <div class=" col-md-4">
                <div class="image-box shadow">
                    <img  class="img-fluid rounded" src="https://images.unsplash.com/photo-1462826303086-329426d1aef5?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Hafar">
                </div>
                <div class=" mt-4">
                    <span class="text-xl">Hafar Albatin Branch</span>
                </div>
            </div>

            <div class=" col-md-4">
                <div class="image-box shadow">
                    <img  class="img-fluid rounded" src="https://images.unsplash.com/photo-1542089363-bba089ffaa25?q=80&w=1470&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Al Jubail">
                </div>
                <div class=" mt-4">
                    <span class="text-xl">Al Jubail Branch</span>
                </div>
            </div>
        </div>
    </div>
